...
import math
import skimage
from data.processing import face3d
from data.processing.face3d import mesh
from data.processing.face3d.morphable_model import MorphabelModel
from data.processing.matlabutil import NormDirection
...
face_mask_np = io.imread("/home/viet/Projects/Pycharm/SPRNet/data/processing/Data/UV/uv_face_mask.png") / 255.
...
uv_kpt = readUVKpt('/home/viet/Projects/Pycharm/SPRNet/data/processing/Data/UV/uv_kpt_ind.txt')
...
def renderMesh(mesh_info, image_shape=None):
    ...
    mesh_image = mesh.render.render_colors(
                                            mesh_info['vertices'],
                                            mesh_info['triangles'],
                                            mesh_info['colors'], 
                                            image_height, 
